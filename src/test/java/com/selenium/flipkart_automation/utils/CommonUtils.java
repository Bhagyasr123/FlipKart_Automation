package com.selenium.flipkart_automation.utils;
...
import com.selenium.flipkart_automation.tests.BaseTest;
...
public class CommonUtils extends BaseTest {
	...
	public static void logTestData(String worksheetName, String testCaseName) {
		...
		extentTest.log(LogStatus.INFO,
				"Test Data For Worksheet Name " + worksheetName + " And For Test Case " + testCaseName);
